...
(async()=>{
  ...
  const REF='/assets/raza-hero-reference.svg';
  ...
  try{const r=await fetch('https://raw.githubusercontent.com/rahireza786-collab/Raza-Mobile-Electronics-/10bf9934717d31db89d6f464c41f25575705f762/app.js',{cache:'no-store'});if(r.ok){const code=await r.text();(0,eval)(code)}}catch(e){console.warn('Catalogue runtime bootstrap:',e)}
